...
$(document).ready(function() {
  // Inisialisasi Select2 untuk semua dropdown wilayah
...
// Validasi nomor telepon - hanya izinkan angka saat input
document.getElementById('telepon').addEventListener('input', function() {
  this.value = this.value.replace(/\D/g, '');
});

// Format nomor telepon ke 62 saat blur (kehilangan fokus)
