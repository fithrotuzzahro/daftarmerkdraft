    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse d-none d-lg-block" id="navbarNav">
            <ul class="navbar-nav ms-auto me-3 gap-2">
                ...
                <li class="nav-item"><a class="nav-link" href="kelola-data-pemohon.php">KELOLA DATA PENGGUNA</a></li>
                <li class="nav-item"><a class="nav-link" href="kelola-admin.php">KELOLA DATA ADMIN</a></li>
            </ul>
...
<div id="mobileMenu" class="mobile-menu">
    <ul class="navbar-nav p-3">
        ...
        <li class="nav-item"><a class="nav-link" href="kelola-data-pemohon.php">KELOLA DATA PENGGUNA</a></li>
        <li class="nav-item"><a class="nav-link" href="kelola-admin.php">KELOLA DATA ADMIN</a></li>
        <li class="mt-3"><a  href="logout.php" class="btn btn-dark w-100"><i class="bi bi-box-arrow-left "></i> Keluar</a></li>
    </ul>
</div>
<div id="overlay"></div>
